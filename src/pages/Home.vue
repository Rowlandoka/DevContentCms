    ...
    <div id="home">
        ...
        <!-- breadcrumb -->
            ...
            <div class="lg:flex justify-between items-center mb-6">
              ...
              <button class="bg-blue-500 hover:bg-blue-600 focus:outline-none rounded-lg px-6 py-2 text-white font-semibold shadow">View Posts</button>
            </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-20">
              ...
              <div class="w-1/2 xl:w-1/4 px-3">
                <div class="w-full bg-white border text-blue-400 rounded-lg flex items-center p-6 mb-6 xl:mb-0">
                  ...
                  <div class="text-gray-700">
                    <p class="font-semibold text-3xl">537</p>
              ...
              <div class="w-1/2 xl:w-1/4 px-3">
                <div class="w-full bg-white border text-blue-400 rounded-lg flex items-center p-6 mb-6 xl:mb-0">
                  ...
                  <div class="text-gray-700">
                    <p class="font-semibold text-3xl">2,467</p>
                    <p>Number of Read Posts</p>
                  </div>
                </div>
              </div>
              ...
              <div class="w-1/2 xl:w-1/4 px-3">
                <div class="w-full bg-white border text-blue-400 rounded-lg flex items-center p-6">
                  ...
                  <div class="text-gray-700">
                    <p class="font-semibold text-3xl">340</p>
                    <p>Subscribers to Newsletter</p>
                  </div>
                </div>
              </div>
              ...
              <div class="w-1/2 xl:w-1/4 px-3">
                <div class="w-full bg-white border text-blue-400 rounded-lg flex items-center p-6">
                  ...
                  <div class="text-gray-700">
                    <p class="font-semibold text-3xl">3,578</p>
                    <p>Number of Likes</p>
                  </div>
            ...
            <div class="flex flex-wrap -mx-3">
              ...
              <!-- <div class="w-full xl:w-1/3 px-3">
                <p class="text-xl font-semibold mb-4">Recent Posts</p>
              ...
              <!-- <div class="w-full xl:w-1/3 px-3">
                <p class="text-xl font-semibold mb-4">Latest Comments</p>
              ...
              <!-- Recent Posts -->
                <div class="w-full xl:w-1/3 px-3">
                <p class="text-xl font-semibold mb-4 text-blue-400">Recent Posts</p>
                <div class="w-full bg-white border rounded-lg p-4">
                  <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
                      <div>
                          <p class="font-semibold text-xl">Martin Murphy</p>
                          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae!</p>
                      </div>
                      <span class="text-green-500 font-semibold text-lg">Dec.12</span>
                  </div>
                  <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
                      <div>
                          <p class="font-semibold text-xl">Joseph Bend</p>
                          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora, consequuntur.</p>
                      </div>
                      <span class="text-red-500 font-semibold text-lg">Dec.3</span>
                  </div>

                  <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
                      <div>
                          <p class="font-semibold text-xl">Jacob Bartos</p>
                ...
                <!-- Recent Articles -->
                <div class="w-full xl:w-1/3 px-3">
                <p class="text-xl font-semibold mb-4 text-green-400">Recent Articles</p>
                <div class="w-full bg-white border rounded-lg p-4">
                  <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
                      <div>
                      ...
                      <span class="text-green-500 font-semibold text-lg">Dec.10</span>
                  </div>
                  <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
                      <div>
                      ...
                      <span class="text-red-500 font-semibold text-lg">Dec.8</span>
                  </div>
                  ...
                  <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
                      ...
                      <span class="text-green-500 font-semibold text-lg">Dec.6</span>
                  </div>
                  ...
                  <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2">
                      ...
                      <span class="text-red-500 font-semibold text-lg">Dec.4</span>
                  </div>
                </div>
              </div>
            ...
            <!-- Latest comments -->
              <div class="w-full xl:w-1/3 px-3">
                <p class="text-xl font-semibold mb-4 text-purple-400">Latest Comments</p>
                <div class="w-full bg-white border rounded-lg p-4">
                  <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
                      <div>
                          <p class="font-semibold text-xl">Trent Murphy</p>
                      ...
                      <span class="text-green-500 font-semibold text-lg">Dec.11</span>
                  </div>
                  <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
                      <div>
                          <p class="font-semibold text-xl">Joseph Brent</p>
