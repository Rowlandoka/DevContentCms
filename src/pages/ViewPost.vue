     ...
     <div class="block overflow-x-auto mx-6">
       <table class="w-full text-left rounded-lg">
         <thead>
          ...
          <tbody>
            <tr v-for="post in Posts" :key="post._id" class="w-full font-light text-gray-700 bg-gray-100 whitespace-no-wrap border border-b-0">
              ...
              <td class="px-3 py-4">{{ post.body }}</td>
                <td class="text-center py-4">
                  <router-link :to="{name: 'edit', params: {id:post._id}}"><span class="bg-blue-600 text-gray-200 rounded hover:bg-blue-500 px-4 py-2 focus:outline-none">edit</span>
                  </router-link>
