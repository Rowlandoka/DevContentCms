<template>
    <div class="sticky top-0 z-40">
            <div class="w-full h-20 px-6 bg-gray-100 border-b-2 flex items-center justify-between">
              ...
              <div class="flex">
                ...
                <div class="inline-block lg:hidden  items-center mr-4">
                  <button class="flexhover:text-blue-500 hover:border-white focus:outline-none navbar-burger" @click="toggleSidebar()">
                ...
                <div class="relative text-gray-600">
                  <input type="search" name="serch" placeholder="Search posts..." class="bg-white h-10 w-full xl:w-64 px-5 rounded-lg border text-sm focus:outline-none">
              ...
              <!-- dropdown menu -->
                <div class="absolute bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48 right-0 top-4 mr-6 mt-12" :class="dropDownOpen ? '' : 'hidden'">
